...
<BlogImage src={split} alt="I am addicted to split screen, even on my 14-inch MacBook Pro" />
...
<BlogImage src={dev} alt="Dev mode looks pretty fresh, doesn't it? All the buttons are so accessible!" />
...
<BlogImage src={space} alt="You can't see the boatload of work I must complete in my USC space..." />
