...
<BlogImage src={ebi} alt="closeup of the shrimp and shredded vegetable tempura" />
...
<BlogImage src={ut1} alt="primavera pasta, vegetable stir fry, veggie pizza, string beans and cherry tomatoes" />
<BlogImage src={ut2} alt="fried rice, tofu, stir-fried vegetables, cantaloupe" />
...
<BlogImage src={revere} alt="Paul Revere House, where the man began his legendary ride" />
<BlogImage src={nerd} alt="North End is absolutely unreal" />
<BlogImage src={ne} alt="sunset at Langone Park, facing Bunker Hill" />
<BlogImage src={chapel} alt="Old North Church, a critical location during Paul Revere's ride signaling British movement" />
...
<BlogImage src={longfellow} alt="Longfellow House-Washington's Headquarters National Historic Site" />
...
<BlogImage src={library} alt="the famed view of the Boston Public Library's interior" />
<BlogImage src={libraryfoyer} alt="view from the second floor of the library of the entrance steps" />
...
<BlogImage src={sk} alt="taro/sweet potato balls, sago, sweet potato, and boba; ~$10.50" />
...
<BlogImage src={bowdoin} alt="Bowdoin Street in front of the State House, with the Athenaeum in the background" />
