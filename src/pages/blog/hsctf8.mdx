...
<BlogImage src={pallets} alt="Red plane 0 served my purpose!" client:visible />
...
<BlogImage src={glass} alt="Colour Inversion (Xor) was pretty clean" client:visible />
...
<BlogImage src={spectrogramsetup} alt="spectrogram setup" client:visible />
...
<BlogImage src={spectrogram} alt="spectrogram" client:visible />
