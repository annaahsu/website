...
<BlogImage src={bbmp} alt="Blueberry muffin, blueberry muffin bake, and fried potato cubes" />
...
<BlogImage src={qhmzc} alt="Vegan quesadilla, ham, blueberry muffin, zucchini, and random vegetables" />
...
<BlogImage src={ramen} alt="Miso ramen, with corn, pork, bean sprouts, green onion, egg, and strange noodles" />
...
<BlogImage src={csp} alt="Chia seed pudding with raspberries and blackberries" />
...
<BlogImage src={spfzgbp} alt="Pork, green beans, zucchini, sweet potato fries, and chicken noodle soup" />
...
Pro tip: if you want the hot line, show up at 11am right when it opens on weekdays and 2pm on weekends. No one else will fight you. You think that would be true for dinner, but after 11:30am it seems like the dining halls are just a never ending stream of people.
...
<BlogImage src={scampi} alt="Shrimp scampi with pasta, white truffle macaroni, curly fries, butter cabbage, and arugula salad" />
...
<BlogImage src={fbsm} alt="Fish, mashed potatoes, brussel sprouts, and mushrooms" />
...
<BlogImage src={pscm} alt="Pasta with alfredo sauce, mushrooms, carrots, shrimp" />
...
<BlogImage src={qpc} alt="Quinoa, cauliflower, and pumpkin on a pretty mid Parkside day" />
...
Luckily, the salmon bowl doesn't have this problem. Its popularity is insane, though, so make sure you order ahead on the app in advance! Wait times can go through the roof, especially during peak lunch rush between 12-1pm.

<BlogImage src={salmonbowl} alt="Salmon bowl; probably my favorite item on campus" />
...
<BlogImage src={chickenbowl} alt="Chicken bowl; pretty good too and you get more food compared to the salmon bowl" />
