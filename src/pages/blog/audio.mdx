...
<BlogImage src={asdt} alt="flow chart using Audio System Design Tool" client:visible />
...
<BlogImage src={directory} alt="view of my directory" client:visible />
...
<BlogImage src={port} alt="tools menu" client:visible />
...
<BlogImage src={ide} alt="IDE display" client:visible />
...
<BlogImage src={loader} alt="Teensy Loader" client:visible />
...
<BlogImage src={side} alt="side view of circuit" client:visible />
<BlogImage src={slant} alt="slant view of circuit" client:visible />
<BlogImage src={top} alt="top view of circuit" client:visible />
...
<BlogImage src={adc} alt="conversion from analog to digital waveform" client:visible />
...
<BlogImage src={adcdac} alt="comparison between what ADC and DAC do" client:visible />
